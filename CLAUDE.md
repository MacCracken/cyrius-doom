...
- **Binary size**: 137KB (20 modules), renders at 3.9ms/frame
- **Status**: v0.19.1 — textured walls, floor flats, sprites, WAD-native HUD, ALSA audio, doors/lifts, automap, level transitions (E1M1-E1M9)
