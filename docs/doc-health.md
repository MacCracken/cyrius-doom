...
| `CHANGELOG.md` | 2026-07-18 | ✅ Fresh | **Source of truth per CLAUDE.md.** Through **v0.34.3** (perf batch A: OP-1 sprite memo + OP-3 loop hoists + OP-6 wad pack + OP-0 bench-truth; byte-identical, −62.5% true frame). v0.34.2 = texture world-lock walls. Refreshed every release. |
