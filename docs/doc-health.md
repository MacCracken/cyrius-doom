...
| `CHANGELOG.md` | 2026-07-08 | ✅ Fresh | **Source of truth per CLAUDE.md.** Through **v0.32.1** (`--audio-test`/`--music-test` separation). v0.32.0 = vani vendoring + render-audit Bites A–D + both render keystones + toolchain 6.4.30. Refreshed every release. |
...
| `completed-phases.md` | 2026-07-08 | ✅ Fresh | **Updated at the v0.32.1 patch** — v0.32.x section now carries both the mega-cut (0.32.0: audit Bites A–D + both render keystones + vani vendoring + pin 6.4.30) and the 0.32.1 audio-test patch row; plus the catch-up v0.31.x section. Chronological one-line index. |
