...
| `CHANGELOG.md` | 2026-07-09 | ✅ Fresh | **Source of truth per CLAUDE.md.** Through **v0.33.0** (native Wayland window backend — desktop rendering). v0.32.1 = audio-test/music-test separation; v0.32.0 = render-audit mega-cut + toolchain 6.4.30. Refreshed every release. |
