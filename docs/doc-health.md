...
| `CHANGELOG.md` | 2026-07-18 | ✅ Fresh | **Source of truth per CLAUDE.md.** Through **v0.34.2** (texture world-lock — walls: TX-1/TX-2 ray-cast U/depth + TX-4 exact `isqrt` length). v0.34.1 = E1M1 fidelity + AGNOS input. Refreshed every release. |
