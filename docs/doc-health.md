...
| `CHANGELOG.md` | 2026-07-17 | ✅ Fresh | **Source of truth per CLAUDE.md.** Through **v0.34.1** (E1M1 fidelity + AGNOS input robustness: EF-1..4 + AG-2/F-U6). v0.34.0 = native-scale vertical texture mapping (F06). Refreshed every release. |
